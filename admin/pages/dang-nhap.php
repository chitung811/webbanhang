...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="index.html"><img class="logo-img" src="../../public/images/5ticon.png" alt="logo"></a><span class="splash-description">Đăng nhập tài khoản</span></div>
            <div class="card-body">
                <form method="POST">

						...
						<div class="col-4 sm_hidden">
							<div class="box">
								<a href="loai-san-pham/Do-be-trai-1-1.html">
									<div class="figure">
										<img src="public/images/banner_project_2.jpg">
										<div class="caption">
											<div class="about">
												<h2>Đồ bé trai</h2>
												<p>Cập nhật những mặc hàng đồ bé trai mới nhất</p>
												<p>
						...
						<div class="col-4 sm_hidden">
							<div class="box">
								<a href="loai-san-pham/Do-be-gai-7-1.html">
									<div class="figure">
										<img src="public/images/banner_project_3.jpg" alt="banner_project_3.jpg">
										<div class="caption">
											<div class="about">
												<h2>Đồ bé gái</h2>
												<p>Cập nhật những mặc hàng đồ bé gái mới nhất</p>
						...
						<div class="col-4 sm_hidden">
							<div class="box">
								<a href="loai-san-pham/Do-tre-so-sinh-10-1.html">
									<div class="figure">
										<img src="public/images/banner_project_4.jpg" alt="banner_project_4.jpg">
										<div class="caption">
											<div class="about">
												<h2>Đồ trẻ sơ sinh</h2>
												<p>Cập nhật những mặc hàng đồ trẻ sơ sinh mới nhất</p>
